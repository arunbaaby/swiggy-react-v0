        ...
        <div>
            {cartItems.length === 0 ? (
                ...
                <div className="grid grid-cols-3 gap-7 mx-4">
                    <div className="col-span-2 bg-white shadow-xl"></div>
                    ...
                    <div>
                        <button
                            className="p-2 text-whitetext-black border rounded-[4px] px-[12px] hover:text-[#FF5200] hover:border-[#FF5200] hover:scale-110 transition-transform duration-300"
            ...
            <div className="cart-wrapper flex flex-col">
                ...
                <h1 className="text-2xl">{JSON.stringify(cartItems)}</h1>
            </div>
        </div>
    );
};
